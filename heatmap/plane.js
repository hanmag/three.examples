...
var heatmapParticleCell = 12;
var heatmapParticleUnit = 30;
var r = 800;
var rHalf = r / 2;
...
function init() {
    ...
    var heatmapCount = heatmapParticleCell * heatmapParticleCell * heatmapParticleUnit;
    ...
    for (var i = 0; i < maxParticleCount; i++) {
        ...
        particlePositions[i * 3 + 1] = r * -0.2;
        particlePositions[i * 3 + 2] = y;
    ...
    material = new THREE.ShaderMaterial({
        uniforms: {
            size: {
                value: window.innerHeight * 0.035 * window.devicePixelRatio
            },
            texture: {
...
function onWindowResize() {
    ...
    material.uniforms.size.value = window.innerHeight * 0.035 * window.devicePixelRatio;
    renderer.setPixelRatio(window.devicePixelRatio);
    renderer.setSize(window.innerWidth, window.innerHeight);
        ...
        if (heatmapParticleIndex.hasOwnProperty(index)) {
            ...
            for (var i = 0; i < particleCount; i++) {
                ...
                if (!updated) {
                    ...
                    particlePositions[i * 3 + 2] += particleData.velocity.y;
                ...
                var dy = particlePositions[i * 3 + 2] - particleDataB[2];
            ...
            if (queue.length > 0) {
                element.points.forEach(point => {
                    ...
                    queue.forEach(pd => {
                        ...
                        var ddy = particlePositions[pd * 3 + 2] - point[1];
